;(function (global, factory) {
  ...
  TYPE_SIZE[GL_SHORT] = TYPE_SIZE[GL_UNSIGNED_SHORT] = TYPE_SIZE[
    GL_HALF_FLOAT_OES
  ] = TYPE_SIZE[GL_UNSIGNED_SHORT_5_6_5] = TYPE_SIZE[
    GL_UNSIGNED_SHORT_4_4_4_4
  ] = TYPE_SIZE[GL_UNSIGNED_SHORT_5_5_5_1] = 2

  TYPE_SIZE[GL_INT] = TYPE_SIZE[GL_UNSIGNED_INT] = TYPE_SIZE[
    GL_FLOAT
  ...
  function reglCore(
    ...
    function parseDraw(options, env) {
      ...
      function parseVAO() {
        if (S_VAO in staticOptions) {
          check$1(
            !staticOptions.elements && !dynamicOptions.elements,
            'cannot specify elements with vao'
          )
    ...
    function parseArguments(options, attributes, uniforms, context, env) {
      ...
      if (attribLocations) {
        check$1(
          !draw.elementsActive,
          'can not combine elements and vertex array objects. element binding state must be specified in vertex array object'
        )
        result.useVAO = true
      } else {
